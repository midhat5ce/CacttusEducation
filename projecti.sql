...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2018 at 06:59 PM
...
INSERT INTO `books` (`book_id`, `u_id`, `book_name`, `book_author`, `category`, `year`, `isbn`, `image`) VALUES
(1, 5, 'Gue Gue Pici Gue', 'Naim Frasheri', '', 0, 0, ''),
(2, 5, 'Art of war', 'Sun Tzu', '', 0, 0, ''),
(3, 5, 'Intellegent Investitor', 'Braham Grifin', '', 0, 0, '');
...
(7, 'z', 'fbade9e36a3f36d3d676c1b808451dd7', 'z', 'z', 'z', 'z');
